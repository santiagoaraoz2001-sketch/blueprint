"""
Graph utilities — planner algorithms and kill-switch validation.

Section A: Canonical graph algorithms for the unified planner.
...
Section B: Safety checks that block dangerous operations on pipelines
  containing loops, custom code blocks, or stale caches.  Referenced by
  the execution contract (V1, sections 3-5).

All functions accept the same node/edge dict format used throughout
Blueprint's pipeline engine.

Determinism guarantee (Section A)
---------------------------------
Every planner function produces identical output given identical input,
...
# ===========================================================================
# Section A — Planner Graph Algorithms
# ===========================================================================
...
# ===========================================================================
# Section B — Kill-Switch Validation
# ===========================================================================

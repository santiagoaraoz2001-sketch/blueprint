...
def init_db():
    ...
    from .models import project, experiment, experiment_phase, pipeline, pipeline_version, run, dataset, artifact, paper, sweep, workspace, experiment_note, preset, pipeline_sequence, execution_decision, model_record  # noqa: F401
